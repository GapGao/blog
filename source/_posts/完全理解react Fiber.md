...
<font color=#FF0000>  注意</font>，requestIdleCallback调度只是希望做到流畅体验，并不能绝对保证什么，例如：
...
如注释指出的，fiber与workInProgress互相持有引用，“喜新厌旧”之后，旧fiber就作为新fiber更新的<font color=#FF0000>预留空间</font>，达到复用fiber实例的目的
